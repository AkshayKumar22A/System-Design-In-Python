class FoodOrder:
    ...
    # Only allows adding iteams before the order is placed
    def add_item(self,name:str,price: float) -> None:
        if self._is_placed:
            print("Cannot modify a placed Ordr.")
            return
        self._items.append(name)
        self._total_amount += price

    # Places the order if it has at least one iteam and hasn't been placed yet
